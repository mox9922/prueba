...
<html>
  <head>
    ...
    <title>Condominio | Panel de Administración</title>
    ...
    <link rel="stylesheet" href="plugins/datatables/SweetAlert.min.css">
    
    <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    <link  rel="icon"   href="storage/configuration/logo.jpg" type="image/png" />
    ...
    <div class="wrapper" >
      ...
      <header class="main-header" >
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">Condominio<b></b></span>
        </a>
...
foreach($products as $product){
  $q= OperacionesData::getCantByStock($product->code,StockData::getPrincipal()->id);
...
<?php endif;?>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  else if(Core::$user->kind==2){ echo " (Auxiliar)"; }
                  else if(Core::$user->kind==3){ echo " (Distribuidor)"; }
                  else if(Core::$user->kind==4){ echo " (Consultor)"; }
                  else if(Core::$user->kind==5){ echo " (Super Usuario)"; }
...
<?php if(Core::$user->kind==1||Core::$user->kind==2||Core::$user->kind==4||Core::$user->kind==5):?>
...
<!-- <?php if(Core::$user->kind==1||Core::$user->kind==2||Core::$user->kind==4||Core::$user->kind==5):?>  Administrador,Almacenista,Vendedor  -->
       ...
       <!--   <li><a href="./?view=reandsell"><i class='fa fa-usd'></i> <span>Vender en CERO</span></a></li> -->
        ...
        <?php if(Core::$user->kind==1):?>
            <li><a href="./?view=sellscredit">Ventas crédito</a></li>
            </ul>    
          <?php endif; ?>
  <?php endif; ?> -->

<?php if(Core::$user->kind==1||Core::$user->kind==2||Core::$user->kind==5):?> <!-- Administrador,Auxiliar,Vendedor -->
<!--            <li><a href="./?view=reandsell"><i class='fa fa-usd'></i> <span>Vender en CERO</span></a></li> -->
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="entregas"||$_GET["view"]=="entrega"||$_GET["view"]=="sells"||$_GET["view"]=="devs"||$_GET["view"]=="dev"||$_GET["view"]=="dev_entrega"||$_GET["view"]=="sell")){ echo "active"; }?>"   >
              <a href="#"><i class='fa fa-shopping-cart'></i> <span>Registros</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">

                <li><a href="./?view=entregas">Entrega</a></li>
                <li><a href="./?view=ventas">Venta</a></li>
                <?php if(Core::$user->kind==5):?>
                  <li><a href="./?view=devs">Devolución</a></li>
   ...
   <?php endif; ?>
           ...
           <!-- <li><a href="./?view=cotizations"><span>Cotizaciones</span></a></li> -->
            ...
            <li><a href="./?view=inventary&stock=<?php echo StockData::getPrincipal()->id;?>"><i class='fa fa-area-chart'></i> <span>Inventario</span></a></li>
                <li><a href="./?view=search"><i class='fa fa-search'></i>  Consultar Existencias</a></li>
                <li><a href="./?view=search"><i class='fa fa-search'></i>Consultar Existencias</a></li>
                <li><a href="./index.php?view=dev"><i class='fa fa-retweet'></i> <span>Devolución</span></a></li>
          <?php endif; ?>
          <?php if(Core::$user->kind==4):?>
				 <!--   <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="search")){ echo "active"; }?>">-->
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">	
					<li>
						<a href="./?view=search"><i class='fa fa-area-chart'></i><span>Consultar Existencias</span><i class="fa fa-angle-left pull-right"></i></a>
					</li>
				</ul>
			</div>
				<!--</li>-->
          ...
          <li><a href="./?view=rescancel">Compras canceladas</a></li>
            ...
            <?php if(Core::$user->kind==1||Core::$user->kind==2||Core::$user->kind==5):?>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=modelos">Tipos</a></li>
                <!-- <li><a href="./?view=categories&opt=all">Categorías</a></li> -->
                <li><a href="./?view=brands&opt=all">Entradas</a></li>
              <!--  <li><a href="./?view=clients">Clientes</a></li> -->
                <li><a href="./?view=providers">Proveedores</a></li>
                <li><a href="./?view=stocks">Distribuidores</a></li>
                <?php if(Core::$user->kind==1||Core::$user->kind==5):?>
                  <li><a href="./?view=prices">Editar Precios</a></li>
                  <?php endif; ?> 
              </ul>
            </li>
            ...
            <?php if(Core::$user->kind==1||Core::$user->kind==5):?>
              <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="recibos"||$_GET["view"]=="credit"||$_GET["view"]=="makepayment" ||$_GET["view"]=="paymenthistory"||$_GET["view"]=="balance"||$_GET["view"]=="spends"||$_GET["view"]=="newspend"||$_GET["view"]=="editspend")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-briefcase'></i> <span>Recibos</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                 <li><a href="./?view=recibos&opt=all">Distribuidores</a></li>
                 <li><a href="./?view=recibos&opt=allprincipal">El Gallo</a></li>
            ...
            <?php endif; ?>
          <?php endif; ?>
            <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="inventary"||$_GET["view"]=="search" ||$_GET["view"]=="inventaries"||$_GET["view"]=="selectstock"||$_GET["view"]=="inventaryval"||$_GET["view"]=="trasps"||$_GET["view"]=="re"||$_GET["view"]=="traspase"||$_GET["view"]=="import2"||$_GET["view"]=="onetraspase"||$_GET["view"]=="onedev")){ echo "active"; }?>">
              ...
              <ul class="treeview-menu">
                ...
                <?php if(Core::$user->kind==5):?>
                  ...
                  <?php endif; ?>
                <?php if(Core::$user->kind==1||Core::$user->kind==2||Core::$user->kind==5):?>
                <li><a href="./?view=search">Consultar Existencias</a></li>
                <li><a href="./?view=inventaries">Inventario Global</a></li>
                <li><a href="./?view=import2">Actualizar Inventario</a></li>
            ...
            <?php if(Core::$user->kind==1||Core::$user->kind==2||Core::$user->kind==5):?>
                        <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="inventorylog"||$_GET["view"]=="sellsbyident"||$_GET["view"]=="reportxestado"||$_GET["view"]=="sellreportsprincipal"||$_GET["view"]=="sellreports"||$_GET["view"]=="existreports"||$_GET["view"]=="resreport"||$_GET["view"]=="paymentreport"||$_GET["view"]=="paymentreport"||$_GET["view"]=="clientreports"||$_GET["view"]=="vendorreports"||$_GET["view"]=="popularproductsreport")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-file-text-o'></i> <span>Reportes</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php if(Core::$user->kind==5):?>
                <li><a href="./?view=inventorylog">Historial de Inventario</a></li>
                <li><a href="./?view=sellsbyident">Por Identificador</a></li>
                <?php endif; ?>
                <li><a href="./?view=sellreports">Ventas</a></li>
                <li><a href="./?view=sellreportsprincipal">Ventas <?php echo StockData::getPrincipal()->name;?></a></li>
                <li><a href="./?view=existreports">Existencias</a></li>
                <li><a href="./?view=reportxestado">Por Estado</a></li>
              <!--   <li><a href="./?view=resreport">Compras</a></li>-->
              <?php if(Core::$user->kind==1||Core::$user->kind==5):?>
                <li><a href="./?view=paymentreport">Reporte de recibos</a></li>
                <?php endif; ?>
                <?php if(Core::$user->kind==5):?>
              <!--   <li><a href="./?view=clientreports">Clientes Populares</a></li>-->
                <li><a href="./?view=vendorreports">Distribuidores Populares</a></li>
            ...
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="users"||$_GET["view"]=="settings" ||$_GET["view"]=="import"||$_GET["view"]=="newuser"||$_GET["view"]=="edituser")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-cog'></i> <span>Usuarios</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=users">Editar Usuarios</a></li>
    ...
    <?php endif;?>
      ...
      <footer class="main-footer">
        ...
        <strong>Derechos Reservados &copy; 2022 <a href="https://wa.me/50684196602" target="_blank">RAG & VQC</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>Condominio</b></a>
      </div><!-- /.login-logo -->
      ...
      <div class="login-box-body"style="background-image:url('login.jpg');width:450px;height:300px;border:1px solid black;background-repeat:no-repeat" align = "center" >
	  <h4 style="color:white;";>Condominio</h4>
        <form action="./?action=processlogin" method="post">
          <div class="form-group has-feedback" style="width: 50%; height: 50%;" >
            <input type="text" name="username" required class="form-control" placeholder="Usuario"/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback" style="width: 50%; height: 50%;">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <button style="width: 50%; height: 50%; type="submit" class="btn btn-primary btn-block btn-flat" >Acceder</button>
              <!--
