            ...
            <table class="table table-padded text-center " id="tabla_modal2" style="width:100%">
                ...
                <?php
                    foreach($deudas As $dt){
                        ...
                        $estado = $this->class_security->select_pago_valor($dt->id,$this->class_data->estado_pago_formal,$dt->estado,'comprobantes_estado_simple',4,$dt->tipo_de_deuda);
                        echo "<tr>
                                 <td>$dt->apt</td>   
                                 <td>$tipo</td>   
                                  <td>$dt->fecha_deuda</td>  
                                 <td>₡ ".number_format($dt->deuda)."</td>   
                                 <td>₡ ".number_format($dt->saldo)."</td>   
                                 <td>$dt->fecha</td>   
                                 <td>$comprobante</td>   
                                 <td>$estado</td>   
                             </tr>";
