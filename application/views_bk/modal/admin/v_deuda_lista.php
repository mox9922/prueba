                ...
                if(isset($deuda)){
                    ...
                    foreach($deuda as $rows){
                        ...
                        echo "<tr> 
                                        ...
                                        <td class='bolder nowrap'><span class='text-success'>₡".number_format($rows->du_saldo)."</span></td>
                                        <td class='bolder nowrap'><span class='text-success'>₡".number_format($rows->saldo)."</span></td>
