                ...
                <table id="modal_table" class="table table-padded text-center">
                    ...
                    if(isset($deudas)){
                        ...
                        foreach($deudas as $pg){
                            ...
                            echo "<tr> 
                                        <td>{$i}</td>
                                        <td class='bolder nowrap'><span class='text-success'>₡".number_format($pg['pg_deuda'])."</span></td>
                                        <td class='bolder nowrap'><span class='text-success'>₡".number_format($pg['agregado'])."</span></td>
