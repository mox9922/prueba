...
<div class="main-wrapper">
    ...
    <!-- Login box.scss -->
    <!-- ============================================================== -->
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?=base_url('assets/'); ?>images/background/login-register.jpg) no-repeat center center; background-size: cover;">
...
<!--                    <h3 class="box-title mb-3">Sign In</h3>-->
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal mt-3 form-material" data-toggle="validator" role="form" method="post" id="data_login" autocomplete="off">
                            <div class="form-group mb-3">
                                <div class="">
                                    <input class="form-control" type="text" required="" placeholder="Usuario" name="username"> </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-auto">
                                        <a href="javascript:void(0)" id="to-recover" class="link font-weight-medium"><i class="fa fa-lock me-1"></i> Restablecer Contraseña?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group text-center mt-4 mb-3">
                                <div class="col-xs-12">
                                    <button class="btn btn-facebook d-block w-100 waves-effect waves-light" type="submit">Ingresar Ahora</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div id="recoverform">
                <div class="logo text-center">
                    <h3 class="font-weight-medium mb-3">Restablecer la contraseña</h3>
                    <img src="<?php echo base_url('assets/'); ?>images/logo.png" alt="">
                </div>

                <div class="row mt-3 form-material">
                    <!-- Form -->
                    <form class="form-horizontal mt-3 form-material" data-toggle="validator" role="form" method="post" id="data_reset" autocomplete="off">
                        <!-- email -->
                        <div class="form-group  mb-4">
                            <div class="col-12">
                                <input class="form-control" type="text" id="u_reset" name="username" required="" placeholder="Usuario">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="d-flex">
                                ...
                                <div class="ms-auto">
                                    <a href="javascript:void(0)" id="to-login" class="link font-weight-medium"><i class="fa fa-lock me-1"></i> Regresar</a>
                                </div>
                            </div>
                        </div>
                        <!-- pwd -->
                        <div class="row mt-3">
                            <div class="col-12">
                                <button class="btn d-block w-100 btn-primary text-uppercase" type="submit" name="action">Restablecer Contraseña</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="<?php echo base_url('assets/'); ?>cr/login.js"></script>
<script>
    $(".preloader").fadeOut();
    // ============================================================== 
