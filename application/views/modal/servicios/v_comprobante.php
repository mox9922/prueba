...
<form role="form" data-toggle="validator" method="POST" class="frm_data" id="frm_data"  autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="custom-file d-flex flex-row-reverse">
                    <input type="file" name="comprobante" required accept=".gif,.jpg,.jpeg,.png,.doc,.docx, .pdf" class="custom-file-input imput_reset" id="customFile" >
        ...
        <div class="row">
            <?php
                if(isset($data->st_comprobante)){
                    $comprobante = $this->class_security->url_documento($data->st_comprobante);
                    echo "
                             <div class='form-group col-md-8'>
                             ...
                             <div class='form-group col-md-4'>
                                ...
                                <input type='text' readonly value='$data->st_atcreate' class='form-control'>
                            </div>
                    ";
