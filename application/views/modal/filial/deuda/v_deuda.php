            ...
            <table id="modal_tabla" class="table table-padded text-center">
                ...
                if(isset($datas)){
                    foreach ($datas As $dt){
                        ...
                        echo "<tr>
                                          <td>$dt->du_nombre</td>
                                          <td class='bolder nowrap'><b class='text-success'>₡ ".$this->class_security->dinero($dt->du_saldo)."</b></td>
                                          <td class='bolder nowrap'><b class='text-success'>₡ ".$this->class_security->dinero($dt->saldo_pagado)."</b></td>
