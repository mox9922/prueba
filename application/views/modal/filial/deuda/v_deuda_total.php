...
<!--            </div>-->
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="m_saldo_cancelar" required onkeyup="$(this).file_upload_file()"  autofocus  class="form-control dinero saldo text-center imput_reset" autocomplete="off">
            </div>
