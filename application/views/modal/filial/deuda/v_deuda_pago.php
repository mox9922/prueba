...
<form role="form" data-toggle="validator" method="POST" class="frm_data" id="frm_data">
    ...
    <div class="modal-body">
        ...
        <div class="row mb-3">
            ...
            <div class="form-group text-center col-md-3">
                <label>Deuda</label>
                <input type="text" value="₡ <?=$this->class_security->dinero($deuda->du_saldo)?>" readonly autofocus  class="form-control text-center imput_reset" autocomplete="off">
            </div>
            ...
            <div class="form-group text-center col-md-3">
                <label>Saldo</label>
                <input type="text" value="₡ <?=$this->class_security->dinero($saldo)?>" readonly autofocus  class="form-control text-center imput_reset" autocomplete="off">
            </div>
        ...
        <?php
            if(in_array($deuda->du_estado,[1,2])){
                echo "
                ...
                <table class="table table-padded text-center">
                    ...
                    if(isset($datas)){
                        foreach ($datas As $dt){
                            ...
                            $monto  = $this->class_security->dinero($dt->pd_monto);
