            ...
            <div class="col-6 col-md-4">
                <a class="element-box el-tablo centered trend-in-corner smaller" href="#">
                    ...
                    <div class="value" id="saldo_cancelar">
                        ₡ <?=$this->class_security->dinero($deuda->pg_deuda)?>
                    </div>
                </a>
            </div>
...
<!--                    </div>-->
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <input class="form-control  text-center imput_reset" readonly id="saldo_restante" value="₡ <?=$this->class_security->dinero($restante)?>" placeholder="Restante..." autocomplete="off" type="text">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    CRC
                                </div>
                            ...
                            <table class="table table-padded text-center">
                                ...
                                if(isset($abonos)){
                                    foreach ($abonos As $dt){
                                        $saldo  = $this->class_security->dinero($dt['aa_monto']);
