        ...
        <div class="row  mt-4">
            <div class="table-responsive">
                <table id="" class="table table-striped table-padded text-center dataTable_report1">
                    ...
                    $tmp1 = '<tr>';
                    $tmp2 = '<tr>';
                    $fase1 = '<th colspan="5">Cuota Agua</th><th colspan="4">Cuota Extraordinaria</th><th colspan="4">Cuota Condominal</th><th colspan="4">Acumulado</th><th colspan="3">Deuda</th>';
                    $fase2 = '
                            <th>Lectura</th>
