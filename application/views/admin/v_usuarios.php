        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-xs-12 d-flex justify-content-start justify-content-md-end align-self-center">
                ...
                if($perfil == 2){
                    ...
                    echo "
                           <a href='javascript:void(0)' class='btn btn-danger btn-sm mx-2' onclick='$(this).forms_modal({\"page\" : \"usuarios_perfiles\",\"title\" : \"perfiles\"})'>Perfiles<i class='ti-plus'></i></a>
                           <a href='javascript:void(0)' class='btn btn-dark  btn-sm' onclick='$(this).forms_modal({\"page\" : \"usuarios\",\"title\" : \"Usuarios\"})'>Agregar Usuarios<i class='ti-plus'></i></a>";
                }
